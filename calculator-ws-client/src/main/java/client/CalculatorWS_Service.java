 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://service.mosad.com/", wsdlLocation = "http://192.168.0.2:8080/soap/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://service.mosad.com/", "CalculatorWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.2:8080/soap/calculator?wsdl");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://service.mosad.com/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.mosad.com/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
